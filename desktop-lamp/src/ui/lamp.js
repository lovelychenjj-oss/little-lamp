...
function post(action,extra){var value=Object.assign({action:action},extra||{});if(window.webkit&&window.webkit.messageHandlers&&window.webkit.messageHandlers.lamp)window.webkit.messageHandlers.lamp.postMessage(value);}
