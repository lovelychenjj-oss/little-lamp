...
> 公开测试版：当前 Mac 0.5.6 / Windows 0.1.3。已完成模拟测试，尚未完成完整实机验证。Windows 曾出现滤色遮挡和任务栏文字显示异常，修复效果仍需用户反馈。
...
蘑菇灯、布罩灯、球形灯、花瓣吊灯、格纹吊灯、复古搪瓷吊灯、纸月灯笼、奶油飞碟吊灯、铃兰吊灯、折叶落地灯。

![七款质感 3D 灯具素材](media/lamps-3d.png)

*图示为七款 3D 风格灯具的静态素材，不是实机截图；应用中另有三款 CSS 灯具。*
